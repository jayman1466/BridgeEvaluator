...
def P6P7Warning():
    ...
    return "Target position 6-7 and donor position 6-7 match, efficiency may be dramatically reduced."

def P7Warning():
    #warnings.warn("Target position 7 and donor position 7 match, efficiency may be significantly reduced.")
    return "Target position 7 and donor position 7 match, efficiency may be significantly reduced."
